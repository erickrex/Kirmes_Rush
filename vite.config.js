...
const assetSourceDir = resolve(repoRoot, 'assets', 'rythm-foundation.assets');
const assetTargetDir = 'assets/rythm-foundation.assets';
...
function rythmAssetBridge() {
  return {
    name: 'rythm-asset-bridge',
    configureServer(server) {
      server.middlewares.use('/assets/rythm-foundation.assets', async (req, res, next) => {
...
export default defineConfig({
  ...
  assetsInclude: [
    ...
    '**/*.svg',
    '**/*.webp',
    // Audio formats (Rythm Foundation uses OGG natively, MP3 for web)
    '**/*.ogg',
    '**/*.mp3',
    '**/*.wav',
    // Data formats
