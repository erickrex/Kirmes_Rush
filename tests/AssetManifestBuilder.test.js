...
describe('AssetManifestBuilder — Property-Based Tests', () => {
      ...
      expect(entries).toEqual([
        {
          ...
          path: 'assets/rythm-foundation.assets/week7/images/smokeRight.png',
          atlasURL: 'assets/rythm-foundation.assets/week7/images/smokeRight.xml'
        },
        {
          type: 'image',
          key: 'stage-tankmanBattlefield-tankGround',
          path: 'assets/rythm-foundation.assets/week7/images/tankGround.png'
        }
      ]);
    });
      ...
      expect(entries).toEqual([
        {
          ...
          path: 'assets/rythm-foundation.assets/shared/images/stageback.png'
        }
      ]);
    });
  });
   ...
   *
   * For any registry-style path without the assets/rythm-foundation.assets/ prefix,
   * both path and atlasURL in produced entries start with assets/rythm-foundation.assets/.
   */
  describe('Property 5: Asset path prefixing correctness', () => {
    it('both path and atlasURL start with assets/rythm-foundation.assets/', () => {
      fc.assert(
        fc.property(
          ...
          (charIds) => {
            ...
            // Registry returns paths that do NOT start with assets/rythm-foundation.assets/
            const characterRegistry = {
            ...
            for (const entry of entries) {
              expect(entry.path.startsWith('assets/rythm-foundation.assets/')).toBe(true);
              if (entry.atlasURL) {
                expect(entry.atlasURL.startsWith('assets/rythm-foundation.assets/')).toBe(true);
              }
            }
          }
        ),
   ...
   *
   * For any path that already includes assets/rythm-foundation.assets/,
      ...
      fc.assert(
        fc.property(
          ...
          (charIds) => {
            ...
            const characterRegistry = {
              getAssetPath: (id) => `assets/rythm-foundation.assets/images/shared/${id}`
            };
            ...
            for (const entry of entries) {
              ...
              expect(entry.path).not.toContain('assets/rythm-foundation.assets/assets/rythm-foundation.assets/');
              if (entry.atlasURL) {
                expect(entry.atlasURL).not.toContain('assets/rythm-foundation.assets/assets/rythm-foundation.assets/');
              }
            }
          }
        ),
        ...
        fc.property(
          fc.array(
            fc.record({
              ...
              path: pathSegmentArb.map((s) => `assets/rythm-foundation.assets/${s}.png`)
            }),
