...
describe('SaveManager', () => {
  ...
  describe('Storage Keys', () => {
    it('should have correct storage keys', () => {
      expect(StorageKeys.OPTIONS).toBe('rythm-options');
      expect(StorageKeys.SCORES).toBe('rythm-scores');
      expect(StorageKeys.PROGRESS).toBe('rythm-progress');
      expect(StorageKeys.VERSION).toBe('rythm-version');
    });
  });
