/**
 * @fileoverview Tests for RythmCamera class
 */
...
const { default: RythmCamera } = await import('../src/graphics/RythmCamera.js');

describe('RythmCamera', () => {
  let mockScene;
  let mockCamera;
  ...
  describe('constructor', () => {
    it('should create with scene and default camera', () => {
      const cam = new RythmCamera(mockScene);
    ...
    it('should create with custom camera', () => {
      ...
      const cam = new RythmCamera(mockScene, customCamera);
    ...
    it('should handle null scene', () => {
      const cam = new RythmCamera(null);
