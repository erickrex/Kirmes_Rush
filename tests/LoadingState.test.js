...
describe('LoadingState', () => {
  ...
  describe('loadAssets', () => {
    ...
    it('should preserve root-relative asset paths', () => {
      state.assets = [
        { type: 'audio', key: 'song-inst', path: 'assets/rythm-foundation.assets/songs/tutorial/Inst.ogg' }
      ];
      ...
      expect(state.load.audio).toHaveBeenCalledWith(
        'song-inst',
        ['assets/rythm-foundation.assets/songs/tutorial/Inst.ogg', 'assets/rythm-foundation.assets/songs/tutorial/Inst.mp3']
      );
    });
  });
    ...
    beforeEach(() => {
      state.init({
        prepareCallback: vi.fn(async () => ({
          assets: [{ type: 'audio', key: 'song-inst', path: 'assets/rythm-foundation.assets/songs/tutorial/Inst.ogg' }],
  ...
  describe('loadAssets — atlas type', () => {
    ...
    it('should queue atlas entries via this.load.atlasXML() for XML atlases', () => {
      state.assets = [
        { type: 'atlas', key: 'char-bf', path: 'assets/rythm-foundation.assets/shared/images/BOYFRIEND.png', atlasURL: 'assets/rythm-foundation.assets/shared/images/BOYFRIEND.xml' }
      ];
      const queued = state.loadAssets();

      expect(state.load.atlasXML).toHaveBeenCalledWith(
        'char-bf',
        'assets/rythm-foundation.assets/shared/images/BOYFRIEND.png',
        'assets/rythm-foundation.assets/shared/images/BOYFRIEND.xml'
      );
