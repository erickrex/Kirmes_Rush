/**
 * @fileoverview Canonical data roots for app-owned manifests and shared Rythm Foundation assets.
 */
...
export const SHARED_ASSET_ROOT = 'assets/rythm-foundation.assets';
