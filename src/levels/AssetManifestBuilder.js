...
/**
 * Prefix a resolved path with `assets/rythm-foundation.assets/` idempotently.
...
export function buildManifest(session, registries) {
  ...
  // default "rythm" style, even when the NoteStyleRegistry async load fails.
  // Without these the game falls back to generated placeholder shapes.
  const coreNoteStyleId = noteStyleId || 'rythm';
