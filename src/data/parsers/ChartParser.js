/**
 * @fileoverview ChartParser - Parser for Rythm Foundation chart JSON format
 * Parses chart and metadata files into usable game data structures.
 *
 * Ported from source/rythm/data/song/SongData.hx
 */
...
/**
 * Parser for Rythm Foundation chart JSON format.
...
class ChartParser {
  ...
  static parsePlayData(playData) {
    ...
    return {
      ...
      noteStyle: playData.noteStyle || 'rythm',
