...
export default class GameOverState extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio(
      'game-over-music',
      'assets/rythm-foundation.assets/shared/music/gameplay/gameover/gameOver.mp3'
    );
    this.load.audio(
      'game-over-end',
      'assets/rythm-foundation.assets/shared/music/gameplay/gameover/gameOverEnd.mp3'
    );

    // Death sound
    this.load.audio(
      'death-sound',
      'assets/rythm-foundation.assets/shared/sounds/gameplay/gameover/rythm_loss_sfx.mp3'
    );
