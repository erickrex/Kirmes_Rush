...
export default class ResultState extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio(
      ...
      'assets/rythm-foundation.assets/shared/music/resultsPERFECT/resultsPERFECT.mp3'
    );
    this.load.audio(
      'result-music-excellent',
      'assets/rythm-foundation.assets/shared/music/resultsEXCELLENT/resultsEXCELLENT.mp3'
    );
    this.load.audio(
      'result-music-normal',
      'assets/rythm-foundation.assets/shared/music/resultsNORMAL/resultsNORMAL.mp3'
    );
  }
