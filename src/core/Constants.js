 ...
 * Ported from source/rythm/util/Constants.hx
 */
...
export const URL_MERCH_FALLBACK = 'https://needlejuicerecords.com/en-ca/pages/rythm-foundation';

/** Link to download the game on Itch.io. */
export const URL_ITCH = 'https://ninja-muffin24.itch.io/rythm';
...
export const URL_KICKSTARTER =
  'https://www.kickstarter.com/projects/rythm/rythm-foundation-the-full-ass-game/';
...
export const DEFAULT_NOTE_STYLE = 'rythm';
...
/**
 * The window of time in which a note is considered to be hit, on the Rythm Legacy scoring system.
