/**
 * @fileoverview Unit tests for FunkinSprite
 */

import { describe, it, expect, beforeEach, vi } from 'vitest';

// Mock Phaser's Sprite class - MUST be set up before importing FunkinSprite
class MockAnimation {
  constructor() {
...
// Mock Phaser globals - MUST be set up before importing FunkinSprite
global.Phaser = {
  GameObjects: {
    Sprite: MockSprite
  },
...
describe('FunkinSprite', () => {
  ...
  beforeEach(() => {
    ...
    sprite = new FunkinSprite(scene, 100, 200, 'testTexture', 'frame1');
  });
  ...
  describe('Static Factory Methods', () => {
    it('should create sprite with FunkinSprite.create', () => {
      const created = FunkinSprite.create(scene, 50, 75, 'myTexture');

      expect(created).toBeInstanceOf(FunkinSprite);
      expect(created.x).toBe(50);
      expect(created.y).toBe(75);
      expect(scene.add.existing).toHaveBeenCalledWith(created);
    });

    it('should create pixel sprite with FunkinSprite.createPixel', () => {
      const created = FunkinSprite.createPixel(scene, 10, 20, 'pixelTexture', 6);
  ...
  describe('Clone', () => {
    it('should create a clone with same properties', () => {
      ...
      expect(cloned).toBeInstanceOf(FunkinSprite);
